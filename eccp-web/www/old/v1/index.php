...
<input type="text" hidden="hidden" name="id_machine" value="<?php echo $machine['id'] ?>" />
...
<input type="button"  value="保存修改" onclick="action_machine_modify(<?php echo $machine['id'] ?>)" />
<input type="button"  value="删除本机" onclick="action_machine_del(<?php echo $machine['id'] ?>)" />
</div>
